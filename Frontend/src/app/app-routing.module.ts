...
import { AddDepartmentComponent } from './app/modules/department/components/add-department/add-department.component';
import { AddEmployeeComponent } from './app/modules/employee/components/add-employee/add-employee.component';
...
const routes: Routes = [
  ...
  { path: 'employee/new', component: AddEmployeeComponent, canActivate: [AuthGuard] },
  ...
  { path: 'department/new', component: AddDepartmentComponent, canActivate: [AuthGuard] },
